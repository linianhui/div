...
#[test]
fn test_read_f32() {
    let mut reader = U8Reader::from(&[0x40, 0x49, 0x0F, 0xDB]);
...
#[test]
fn test_read_f64() {
    let mut reader = U8Reader::from(&[0x40, 0x09, 0x21, 0xFB, 0x54, 0x43, 0xD1, 0xA8]);
...
#[test]
fn test_read_i32() {
    let mut reader = U8Reader::from(&[0x12, 0x34, 0x56, 0x78];
...
#[test]
fn test_read_i64() {
    let mut reader = U8Reader::from(&[0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0]);
...
#[test]
fn test_read_u16() {
    let mut reader = U8Reader::from(&[0xCA, 0xFE, 0xBA, 0xBE]);
...
#[test]
fn test_read_u32() {
    let mut reader = U8Reader::from(&[0xCA, 0xFE, 0xBA, 0xBE, 0x12, 0x34]);
